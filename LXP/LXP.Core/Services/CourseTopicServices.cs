...
namespace LXP.Core.Services
{
    public class CourseTopicServices:ICourseTopicServices
    {
        ...
        public CourseTopicListViewModel GetTopicDetailsByTopicNameAndCourseId(string topicName, string courseId)
        {
            Course course = _courseRepository.GetCourseDetailsByCourseId(Guid.Parse(courseId));
            Topic topic=_courseTopicRepository.GetTopicDetailsByTopicNameAndCourse(topicName, course);
