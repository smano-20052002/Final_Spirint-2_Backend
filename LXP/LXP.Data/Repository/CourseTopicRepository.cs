...
namespace LXP.Data.Repository
{
    public class CourseTopicRepository:ICourseTopicRepository
    {
        ...
        public Topic GetTopicDetailsByTopicNameAndCourse(string topicName, Course course)
        {
            return _lXPDbContext.Topics.FirstOrDefault(topic=>topic.Name==topicName&&topic.Course==course);
        }
